...
import numpy as np
from .kcr_collate import collate, collate_pair
...
def build_dataloader_kcr(
    ...
    **kwargs
    ...
    Args:
        dataset (Dataset): A PyTorch datasets.
        ...
        persistent_workers (bool): If True, the data loader will not shutdown
            the worker processes after a datasets has been consumed once.
    ...
    data_loader = DataLoader(
        ...
        collate_fn=partial(collate_pair, samples_per_gpu=samples_per_gpu),
        pin_memory=False,
