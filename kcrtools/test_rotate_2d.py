...
def parse_args():
    ...
    parser.add_argument('--config', default="../cfg/cfg_kcr/hrsc/kcr_hrsc_ship_coco.py")
    parser.add_argument('--checkpoint', default='/data/alan/q1/workspace/mmStorage/KCR/kcr_hrsc_ship_coco_rotaug/epoch_50.pth')
    parser.add_argument('--show-dir', default='/data/alan/q1/workspace/mmStorage/KCR/kcr_hrsc_ship_coco_rotaug/visual')
    parser.add_argument(
        '--work-dir',
